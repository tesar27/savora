...
class HomeScreen extends StatelessWidget {
  ...
  static const List<DealSectionModel> _sections = <DealSectionModel>[
    DealSectionModel(title: 'Nearby', items: <DealCardModel>[
      DealCardModel(
        imageUrl:
    ...
    DealSectionModel(title: 'Top 10 Highlights', items: <DealCardModel>[
      DealCardModel(
        imageUrl:
    ...
    DealSectionModel(title: 'Trending', items: <DealCardModel>[
      DealCardModel(
        imageUrl:
    ...
    DealSectionModel(title: 'Top Rated', items: <DealCardModel>[
      DealCardModel(
        imageUrl:
    ...
    DealSectionModel(title: 'New on Savora', items: <DealCardModel>[
      DealCardModel(
        imageUrl:
    ...
    DealSectionModel(title: 'My Favorites', items: <DealCardModel>[
      DealCardModel(
        imageUrl:
    ...
    DealSectionModel(title: 'Pizza', items: <DealCardModel>[
      DealCardModel(
        imageUrl:
